...
import com.elend.p2p.workflow.WorkflowUtils;
...
public class WorkflowTraceServiceImpl implements WorkflowTraceService {
    ...
    private Task getCurrentTaskInfo(ProcessInstance processInstance) {
        Task currentTask = null;
        try {
            String activitiId = (String) PropertyUtils.getProperty(processInstance,
                                                                   "activityId");
    ...
    @Override
    public InputStream getInstanceResource(String type,
